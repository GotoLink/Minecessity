...
public class Y_NewRender extends RenderBlocks
{
    protected Y_NewRender()
    {
		super();
    }
	...
	public boolean renderCeilLamp(RenderBlocks renderblocks, IBlockAccess iblockaccess, int i, int j, int k, Block block) 
	{
        ...
        double tX1 = ((float)p1 + 15.99F) / 256F;
        double tY1 = (float)p2 / 256F;
        double tX2 = (float)p1 / 256F;
        double tY2 = ((float)p2 + 15.99F) / 256F;
		...
		texture = Block.glowStone.blockIndexInTexture;
		
		p1 = (texture & 0xf) << 4;
        p2 = texture & 0xf0;
		
        tX1 = ((float)p1 + 15.99F) / 256F;
        tY1 = (float)p2 / 256F;
        tX2 = (float)p1 / 256F;
        tY2 = ((float)p2 + 15.99F) / 256F;
